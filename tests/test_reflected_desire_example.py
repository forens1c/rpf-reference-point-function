...
FIXTURE = ROOT / "examples" / "reflected-desire-input-0.2.json"
...
class ReflectedDesireExampleTests(unittest.TestCase):
    def test_norm_deficit_desire_chain_remains_ambiguous(self) -> None:
