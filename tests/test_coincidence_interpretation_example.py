...
FIXTURE = ROOT / "examples" / "coincidence-interpretation-input-0.2.json"
...
class CoincidenceInterpretationExampleTests(unittest.TestCase):
    def test_ambiguous_meaning_causality_frame_warns(self) -> None:
